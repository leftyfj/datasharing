...
<body  style="padding-top:70px;">
  ...
  <main>
    <div class="container pc-only bg-light p-4">
       <h2><caption><i class="fas fa-code-branch" style="color:orange;"></i>&nbsp;バージョン管理</caption></h2>
       <ul class="list-group my-4 " style="text-decoration:none;">
          ...
          <li class="list-group-item"><a href="version_register.php" style="text-decoration:none;">&nbsp;&nbsp;&nbsp;変更内容登録</a></li>
      </ul>
    </div> <!--end container-->
  </main>
   <?php if($flag):?>
