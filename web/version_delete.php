...
if(strpos($former_url, SITE_URL.'version_list.php') == 0) {
  ...
  $stmt_log->bindValue(':action', $action_array['delete_version']."【バージョンNo.".$id_to_delete."】");
  $stmt_log->execute();
  unset($pdo);

  header('Location: '.SITE_URL.'version_list.php');
