...
if (!isset($_SESSION['USER'])) {
    ...
    exit;
} elseif ($former_url != SITE_URL.'user_signup.php') {
...
<!-- Icon  Place your kit's code here -->
 <script src="https://kit.fontawesome.com/d7931251a6.js" crossorigin="anonymous"></script>
  <title><?php echo SITE_TITLE; ?> | 登録完了</title>
</head>
<body  style="padding-top:70px;">
  ...
  <main>
    <div class="container bg-light p-4">
          <div class="alert text-center alert-success mx-auto w-50 pb-3"><p class="font-weight-bold">新規ユーザー登録を完了しました</p></div>
